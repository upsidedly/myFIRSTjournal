...
Where:
- $u(t)$ = Controller output (motor power)
...
- $r(t)$ = Target (reference) value
- $y(t)$ = Current (measured) value
- $e(t)$ = Error

**Example:** If your arm is at 10° and you want 50°:
- Error = $50° - 10° = 40°$
- If $K_p = 0.05$, then $P = 0.05 \times 40 = 2.0$ (power)
...
```math
I[k] = K_i \sum_{i=0}^{k} e[i] \cdot \Delta t
```
